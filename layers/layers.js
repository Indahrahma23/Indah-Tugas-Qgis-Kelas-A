...
var lyr_2021_0 = new ol.layer.Vector({
    ...
    <img src="styles/legend/2021_0_2.png" /> 83,8 - 89,2<br />\
    <img src="styles/legend/2021_0_3.png" /> 89,2 - 93<br />\
...
var lyr_2022_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/2022_1_1.png" /> 77,4 - 84,2<br />\
    <img src="styles/legend/2022_1_2.png" /> 84,2 - 89,2<br />\
    <img src="styles/legend/2022_1_3.png" /> 89,2 - 92,6<br />\
    <img src="styles/legend/2022_1_4.png" /> 92,6 - 98<br />'
        });
...
var lyr_2023_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: '2023<br />\
    <img src="styles/legend/2023_2_0.png" /> 66 - 77,8<br />\
    <img src="styles/legend/2023_2_1.png" /> 77,8 - 85,8<br />\
    <img src="styles/legend/2023_2_2.png" /> 85,8 - 90<br />\
    <img src="styles/legend/2023_2_3.png" /> 90 - 92,6<br />\
    <img src="styles/legend/2023_2_4.png" /> 92,6 - 99<br />'
        });
...
lyr_2021_0.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'objektif': 'objektif', });
lyr_2022_1.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'objektif': 'objektif', });
lyr_2023_2.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'objektif': 'objektif', });
lyr_2021_0.set('fieldImages', {'PROVINSI': 'TextEdit', 'objektif': 'TextEdit', });
lyr_2022_1.set('fieldImages', {'PROVINSI': 'TextEdit', 'objektif': 'Range', });
lyr_2023_2.set('fieldImages', {'PROVINSI': 'TextEdit', 'objektif': 'Range', });
lyr_2021_0.set('fieldLabels', {'PROVINSI': 'no label', 'objektif': 'no label', });
lyr_2022_1.set('fieldLabels', {'PROVINSI': 'no label', 'objektif': 'no label', });
lyr_2023_2.set('fieldLabels', {'PROVINSI': 'no label', 'objektif': 'no label', });
